...
const IframeHTMLTemplate = (
  ...
  const isEnableNewHeightForIFrame = !DeviceInfo.isTablet() && !Platform.isPad && isNewHeightEnabled;
  ...
  <body style="font-size:${fontSize};border:none;font-family:BalooThambi-Regular" dir="${direction}">
  ...
  <fieldset id="contentField" style="border:none;" >  
    ...
    ${!isReport && IFRAME_DYNAMIC_HEIGHT_SETTER(width, isExplanation, isEnableNewHeightForIFrame)}
    </script>
  </body>
  <script>
  setTimeout(function () {
