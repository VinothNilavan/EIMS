...
const ContentServiceHTMLTemplate = (content, largeFont, isRTL, userLang, alignLeft,
  isTable, instruction, audioDetails) => {
  let fontSize = '16px';
  if (largeFont) {
    fontSize = '16px';
  }
  ...
  <fieldset id="contentField" style="border:none;font-family: BalooThambi-Regular;" >  
    ${content}
    </fieldset>
